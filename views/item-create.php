...
<div class="container">
    <h1>Insertar Documento PDF</h1>
    <form enctype="multipart/form-data" method="POST" action="?action=store">
        <label for="nombre">Nombre</label>
        <input type="text" id="nombre" name="nombre" placeholder="Nombre del archivo" required>
